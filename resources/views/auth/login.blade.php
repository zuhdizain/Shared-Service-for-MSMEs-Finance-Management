                        ...
                        <div class="col">
                            <div class="p-5">
                                <div class="text-center">
                                    ...
                                    <h2 class="h6 text-gray-900">Aplikasi Manajemen untuk UMKM Indonesia</h2>
                                </div>
                                ...
                                <form method="POST" action="{{ route('login') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user @error('email') is-invalid @enderror" name="email"
                                            id="email" aria-describedby="emailHelp" placeholder="Masukkan Email..." autofocus required value="{{ old('email') }}">
                                            @error('email')
                                ...
                                <div class="text-center small">
                                    Untuk pembuatan akun dan keluhan kendala, 
                                    <br>silahkan hubungi <a href="{{ url('/callCenter') }}">DISINI</a>
                                </div>
                            </div>
