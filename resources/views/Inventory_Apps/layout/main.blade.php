    ...
    <div id="wrapper">
        ...
        @else
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('confirm.index') }}">
                ...
                @if(Auth::user()->position == 'Staff Inventory' || Auth::user()->position == 'Supplier')
                <!-- Divider -->
                ...
                <li class="nav-item">
                    ...
                    @if(Auth::user()->position == 'Staff Inventory')
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <p class="dropdown-item" href="{{ url('/myProfileInven') }}">
