                    ...
                    <div class="card-body row justify-content-center">
                        <div class="row g-3 container align-items-center">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                placeholder="example@example.com" id="employee_email" value="{{ old('employee_email') }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control bg-light border-0 small" name="employee_acceptanceDate" id="employee_acceptanceDate" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="employee_phone" class="form-label font-weight-bold">No. telp</label>
                                <input type="number" id="phone" class="form-control bg-light border-0 small" name="employee_phone" id="employee_phone" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="last_education" class="form-label font-weight-bold">Pendidikan Terakhir</label>
                                <input type="text" class="form-control bg-light border-0 small" name="last_education" id="last_education" required>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                value="{{ old('employee_religion') }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="employee_child" class="form-label font-weight-bold">Anak</label>
                                <input type="number" class="form-control bg-light border-0 small" name="employee_child" required 
                                placeholder="Jika tidak ada isi 0" id="employee_child">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="employee_age" class="form-label font-weight-bold">Umur</label>
                                <input type="number" class="form-control bg-light border-0 small" name="employee_age" id="employee_age" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                value="{{ old('employee_hospitalChart') }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="file" class="btn btn-primary btn-sm shadow-sm" name="employee_image" id="employee_image" required>
                            ...
                            <div class="col mb-3">
                                ...
                                <textarea class="form-control bg-light border-0 small" name="employee_address" rows="3" required></textarea>
                            </div>
                        </div>
