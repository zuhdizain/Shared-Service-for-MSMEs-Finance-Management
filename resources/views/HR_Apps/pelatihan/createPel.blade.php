    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="col mb-4">
                ...
                <h6 class="h6 mb-0 text-gray-800">Silahkan tambah data pelatihan pada form berikut dan isi sesuai dengan format data yang tersedia.</h6>
            </div>
                        ...
                        <div class="align-items-center">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    placeholder="example@example.com" value="{{ old('employee_email') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="card-body container">
                        ...
                        <div class="align-items-center">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="training_name" id="training_name" class="form-control bg-light border-0 small" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="training_institute" class="form-label font-weight-bold col-sm-2">
                                    Penyelenggara</label>
                                <div class="col-sm-10">
                                    <input type="text" name="training_institute" id="training_institute" class="form-control bg-light border-0 small" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" name="startDate" id="startDate" class="form-control bg-light border-0 small" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" name="endDate" id="endDate" class="form-control bg-light border-0 small" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="training_phone" class="form-label font-weight-bold col-sm-2">
                                    No. Telp</label>
                                <div class="col-sm-10">
                                    <input type="number" name="training_phone" id="training_phone" class="form-control bg-light border-0 small" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control bg-light border-0 small" name="training_address" rows="3" required></textarea>
                                </div>
                            </div>
                        </div>
